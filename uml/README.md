...
| `componentes.puml`        | Componentes  | Arquitectura del sistema mostrando Frontend, Backend, DB y Lector NFC USB        |
...
1. Lectura de tarjeta y emulación de teclado por Lector NFC USB
2. Captura automática por el Frontend Next.js
3. Petición y validación en el Backend NestJS
4. Verificación de horario y cálculo automático de retardo
5. Guardado en base de datos PostgreSQL
6. Retroalimentación visual en pantalla (éxito/error)
...
- Captura de UID por emulación HID USB (Lector NFC USB)
